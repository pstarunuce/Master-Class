...
//  Flickr
//
//  Created by Srikanth KV on 20/06/19.
...
struct APIClient {
    static func fetchPhotos(text: String, completion: @escaping (_ success: Bool, _ photoResponse: PhotosResponse?) -> Void) {
        let urlString = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=f2ddfcba0e5f88c2568d96dcccd09602&format=json&nojsoncallback=1&safe_search=1&text=\(text)"
